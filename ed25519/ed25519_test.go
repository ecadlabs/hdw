...
var edTestData = []testChain{
	{
		...
		keys: []testKeyData{
			...
			{
				path:    []uint32{0 | hdw.BIP32Hard, 1 | hdw.BIP32Hard},
			...
			{
				path:    []uint32{0 | hdw.BIP32Hard, 1 | hdw.BIP32Hard, 2 | hdw.BIP32Hard},
			...
			{
				path:    []uint32{0 | hdw.BIP32Hard, 1 | hdw.BIP32Hard, 2 | hdw.BIP32Hard, 2 | hdw.BIP32Hard},
			...
			{
				path:    []uint32{0 | hdw.BIP32Hard, 1 | hdw.BIP32Hard, 2 | hdw.BIP32Hard, 2 | hdw.BIP32Hard, 1000000000 | hdw.BIP32Hard},
	...
	},
	{
		...
		keys: []testKeyData{
			...
			{
				path:    []uint32{0 | hdw.BIP32Hard, 2147483647 | hdw.BIP32Hard},
			...
			{
				path:    []uint32{0 | hdw.BIP32Hard, 2147483647 | hdw.BIP32Hard, 1 | hdw.BIP32Hard},
			...
			{
				path:    []uint32{0 | hdw.BIP32Hard, 2147483647 | hdw.BIP32Hard, 1 | hdw.BIP32Hard, 2147483646 | hdw.BIP32Hard},
			...
			{
				path:    []uint32{0 | hdw.BIP32Hard, 2147483647 | hdw.BIP32Hard, 1 | hdw.BIP32Hard, 2147483646 | hdw.BIP32Hard, 2 | hdw.BIP32Hard},
	...
	// BOLOS
	{
		...
		keys: []testKeyData{
			{
				path:    []uint32{738197632 | hdw.BIP32Hard, 335544448 | hdw.BIP32Hard, 0 | hdw.BIP32Hard, 0 | hdw.BIP32Hard},
			...
			{
				path:    []uint32{738197504 | hdw.BIP32Hard, 335544320 | hdw.BIP32Hard, 16777216 | hdw.BIP32Hard, 33554432 | hdw.BIP32Hard},
			...
			{
				path:    []uint32{44 | hdw.BIP32Hard, 148 | hdw.BIP32Hard, 0 | hdw.BIP32Hard, 0 | hdw.BIP32Hard},
			...
			{
				path:    []uint32{44 | hdw.BIP32Hard, 148 | hdw.BIP32Hard, 1 | hdw.BIP32Hard, 2 | hdw.BIP32Hard},
	...
	for _, chain := range edTestData {
		...
		t.Run(name, func(t *testing.T) {
			...
			for _, k := range chain.keys {
				result := hdw.PrivateKey(root)
				for _, index := range k.path {
					var err error
					result, err = result.Derive(index)
